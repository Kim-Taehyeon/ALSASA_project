...
public class OwnerMoney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_money);
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                while(i.hasNext()) {
                    ...
                    if(x==0)
                    {
                        ...
                        {
                            SingerItem3 item = new SingerItem3(name, hour,tempmoney2,R.drawable.personc);
                    ...
                    else
                    {
                        ...
                        {
                            SingerItem3 item = new SingerItem3(name, hour,tempmoney2,R.drawable.persond);
                            adapter.addItem(item);
                            x=0;
                        }
                        else
        ...
        slavelist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                cd5 = new Custom5(OwnerMoney.this,tempname,temphour,tempwage,R.drawable.ownercal);
                cd5.show();
            }
        });
    }
