...
public class TimerChatList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer_chat_list);
        ...
        NewChatRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final EditText et_inDialog = new EditText(TimerChatList.this);
                final AlertDialog.Builder builder = new AlertDialog.Builder(TimerChatList.this);
